...
<?php 
    $b=$data->row_array();
?>
<center><h1>Faktur Konsumen</h1></center>
<table border="0" align="center" style="width:700px;border:none;">
        ...
        <tr>
            ...
            <th style="text-align:left;">Ke Alamat</th>
            <th style="text-align:left;">: <?php echo $b['alamat_jual'];?></th>
        </tr>
        <tr>
            <th style="text-align:left;">Atas Nama</th>
            <th style="text-align:left;">: <?php echo $b['nama_jual'];?></th>
