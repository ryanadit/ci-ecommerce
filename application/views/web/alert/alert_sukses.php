        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="alert alert-success">
                    ...
                    <a class="btn btn-default" href="<?php echo base_url().'web/penjualan'?>"><span class="fa fa-backward"></span>Kembali</a>
                    <a class="btn btn-info" href="<?php echo base_url().'web/penjualan/cetak_faktur'?>" target="_blank"><span class="fa fa-print"></span>Cetak</a>
                </div>
            </div>
        </div>
        <!-- /.row -->
