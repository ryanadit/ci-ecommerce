    ...
    <div class="container">
            ...
            <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/barang/tambah_barang'?>" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <input name="userfile" class="form-control" type="file" placeholder="Gambar Barang..." style="width:335px;" required>
                        </div>
                    </div>
        ...
        <?php
                ...
                <div id="modalEditPelanggan<?php echo $id?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                    ...
                    <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/barang/edit_barang/'.$id ?>" enctype="multipart/form-data">
                        <div class="modal-body">
                        ...
                        <div class="form-group">
                        <label class="control-label col-xs-3" >Gambar(<?php echo $gb; ?>)</label>
                        <div class="col-xs-9">
                            <input name="userfile" class="form-control" type="file" value="<?php echo $gb; ?>" placeholder="Gambar Barang..." style="width:335px;" required>
                        </div>
                    </div>
