...
class Penjualan extends CI_Controller{
	...
	function pemesanan(){
		$x['data']=$this->m_penjualan->pemesanan();
		$this->load->view('admin/v_monitor_penjualan',$x);
	}

	function hapus_pemesanan(){
		$kode=$this->input->post('kode');
		$this->m_penjualan->hapus_pemesanan($kode);
		redirect('admin/penjualan/pemesanan');
	}
	...
	function cetak_pemesanan($nofak){
		$x['data']=$this->m_penjualan->cetak_pemesanan($nofak);
		$this->load->view('admin/laporan/v_faktur',$x);
	}
